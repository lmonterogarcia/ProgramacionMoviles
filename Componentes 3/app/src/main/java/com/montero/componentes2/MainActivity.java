...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rbDam.setOnClickListener(v -> calcular());
        rbDaw.setOnClickListener(v -> calcular());
        rbAsir.setOnClickListener(v -> calcular());
        rbManana.setOnClickListener(v -> calcular());
        rbTarde.setOnClickListener(v -> calcular());
        rbOnline.setOnClickListener(v -> calcular());
        swIva.setOnClickListener(v -> calcular());
